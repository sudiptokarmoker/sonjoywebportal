...
class SongsCategoryRepository implements SongsCategoryRepositoryInterface
{
    ...
    public function all()
    {
        return PostsCategoryModel::where('parent_id', '=', $this->songs_category_id)->
            orderBy("id", "asc")
            ->get()
            ->map(function ($row) {
                return [
    ...
    public function save(array $data)
    {
        ...
        PostsCategoryModel::create([
            ...
            'parent_id' => $this->songs_category_id
        ]);
        return;
    }
    // edit
