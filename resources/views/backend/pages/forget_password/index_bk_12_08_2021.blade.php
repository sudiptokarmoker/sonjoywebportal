                ...
                <tr>
                    <td style="text-align:center;">
                        ...
                        <div style="background-color: #fff; padding: 30px; border-radius: 6px; text-align: left; min-height: 407px; box-sizing: border-box;">
                            ...
                            {{-- <p>Here is the following link of password resets. just on this link below and reset your password</p> --}}
                            <br />
                            <p>Here is the following password reset code : {{ $details['token'] }}</p>
                            <br />
                            <p>Just copy this code and reset your password</p>
                            <br />
                            {{-- <a href="{{ $details['link_url'] }}">Click here for reset your password</a> --}}
                            <p>Thank you</p>
                            {{-- end of email body --}}
                        </div>
