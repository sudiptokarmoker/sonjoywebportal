...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            <div class="page-title-box">
                <h4 class="page-title">Create Verses</h4>
                <!-- breadcumbs -->
    ...
    <div class="row">
        ...
        <form action="{{ route('verses.store') }}" method="POST" class="p20" autocomplete="off" enctype="multipart/form-data">
            <h4 class="header-title"><b>Create Verses</b></h4>
            @csrf
                    ...
                    <div class="p20">
                        <div>
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <label for="title">Verses Title In Bengali</label>
                            </div>
                            <div class="form-floating mb-3">
                                ...
                                <label for="title_in_english">Verses Title In English</label>
                            </div>
                            <div class="form-floating mb-3">
                            ...
                            <div class="form-group">
                                <input type="hidden" name="root_category_id" value="{{ $versesRootCategoryId }}" />
