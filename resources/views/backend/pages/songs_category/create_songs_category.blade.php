...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            <div class="page-title-box">
                <h4 class="page-title">Create Song Catgory</h4>
                <!-- breadcumbs -->
    ...
    <div class="row">
        ...
        <form action="{{ route('songs_category.store') }}" method="POST" class="p20" autocomplete="off">
            <h4 class="header-title"><b>Create Song Catgory</b></h4>
            @csrf
