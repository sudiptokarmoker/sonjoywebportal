...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            <div class="page-title-box">
                <h4 class="page-title">Artists Lists</h4>
                <!-- breadcumbs -->
    ...
    <!-- end row -->
    <div class="row">
        @if (Auth::user()->hasPermissionTo('artists.create.form.view'))
        <div>
            <p class="float-right">
                <a class="btn btn-warning waves-effect waves-light text-white fl-r" href="{{ route('artists.create') }}" type="button">Create Artists</a>
            </p>
        </div>
        @endif
    </div>
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            <div class="card-box table-responsive">
                <h4 class="header-title"><b>Artists List</b></h4>
                <div class="p20">
