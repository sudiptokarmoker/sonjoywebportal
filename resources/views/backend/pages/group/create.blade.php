    ...
    <div class="main-content-inner">
        <div class="row">
            ...
            <div class="col-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">Create Permission Group</h4>
                        <div>
                            ...
                            <form action="{{ route('group.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="group_name" id="txtPermissionGroupName"
                                        class="form-control" placeholder="type permission group name" />
                                </div>
                                <div class="form-group">
