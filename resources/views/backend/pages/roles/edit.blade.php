...
<ul class="breadcrumbs pull-left">
    <li><a href="{{ route('admin.home') }}">Dashboard Home</a></li>
                        ...
                        <form action="{{ route('roles.update', $role->id) }}" method="POST">
                            ...
                            <div class="form-group permission-checkbox-raw-wrapper">
                                ...
                                <div class="row">
                                    ...
                                    /*
                                    this $permissions will just return like this from previous system : 
                                    ...
                                    <div class="col-4">
                                        <div class="form-check">
                                            <div class="custom-control custom-checkbox mr-sm-2">
                                                <input type="checkbox" class="custom-control-input pr-group-{{ $i }}" id="checkPermissionGroup-{{ $i }}" value="{{ $group->group_name }}" onclick="checkPermissionByGroupName('role-{{ $i }}-management-checkbox', this)" {{ count($permissions) > 0 && App\Models\User::roleHasPermissions($role, $permissions) ? 'checked' : '' }} />
