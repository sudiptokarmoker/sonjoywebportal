                ...
                <tr>
                    <td style="text-align:center;">
                        ...
                        <div style="background-color: #fff; padding: 30px; border-radius: 6px; text-align: left; min-height: 407px; box-sizing: border-box;">
                            ...
                            <p>An withdraw request sent by an counsellor account.</p>
                            <br />
                            <h4>Details</h4>
                            <p>
                                Counsellor Name : {{ $details['full_name'] }}
                                <br/>
                                Counsellor ID : {{ $details['counsellor_id'] }}
                                <br/>
                                Withdraw Reqeust ID  : {{ $details['withdraw_id'] }}
                                <br/>
                                Request Date : {{ $details['created_at'] }}
                                <br/>
                                Amount : {{ $details['amount'] }}
                                <br/>
                                Currency : {{ $details['currency'] }}
                                <br/>
                                Withdraw method : {{ $details['withdraw_by_type_name'] }}
                            </p>
                            <a href="{{ $details['link_url'] }}">Click here for further processign of this request</a>
                            <p>Thank you</p>
                            {{-- end of email body --}}
                        </div>
